...
export default function Details() {
  return (
    <section className="overflow-hidden grid grid-cols-2 mx-auto w-full md:w-11/12 [background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('/src/Assets/img/interior.jpg')] md:bg-interior bg-cover bg-center bg-no-repeat">
      <div className="col-span-2 md:col-span-1 h-full bg-transparent md:bg-black px-3 py-8">
        <div className="text-center mb-10">
          <h1
            className="text-white text-lg md:text-xl tracking-[3px] uppercase after:bg-purple-700 after:inline-block after:h-[1px] after:relative after:align-middle after:w-1/4 before:bg-purple-700 before:inline-block before:h-[1px] before:relative before:align-middle before:w-1/4">
            Work Flow
          </h1>
          <h3
